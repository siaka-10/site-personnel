<!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="http://localhost/pscpd/assets/index3.html" class="brand-link">
      <img src="http://localhost/pscpd/assets/img/logo.ico" alt="pscpd Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="https://mail.google.com/mail/?tab=rm&ogbl" class="nav-link">
